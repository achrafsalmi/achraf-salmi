            ...
            <div class="container">
                ...
                <div class="portfolioContainer wow fadeInUp delay-04s">
                    ...
                    <div class=" Portfolio-box branding">
                        ...
                        <fieldset>
                            <legend>Reclamation WF</legend>
                            <input type="radio" name="group" value="value1">enabled

                        </fieldset>


                        <form action="up_help_desk" method="post" enctype="multipart/form-data" disabled="disabled">


                            <script>$("input[value='value1']").change(function () {
                                    $("input[name='items_radius']").prop('disabled', false);
                                    $("input[name='bt_helpdesk']").prop('disabled', false);
                            ...
                            <br>
                            <input type="submit" name="bt_helpdesk" value="Upload" disabled="disabled"/>
                        </form>
                    </div>
                </div>
                <!--   *******************************************************************************
