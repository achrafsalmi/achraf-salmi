<%@page import="connexion.connection_historadius"%>
)<%-- 
        ...
        <nav class="main-nav-outer" id="test">
            ...
            <div class="container">
                <ul class="main-nav">
                    ...
                    <li><a href="<%=request.getContextPath() + "/page auth"%>">historique action</a></li>
            ...
            <div class="container">
                ...
                <center>
                    <%persImpli ps = new persImpli();
                        ...
                        ResultSet res = null;
                        connection_historadius conn = null;
                ...
                <div class="portfolioFilter">
                    <center>
                        ...
                        <form method="post" action="acct_histo">
                            ...
                            <input type="submit" name="bt_histo" value="historique__total">
                        </form>
                        <%}%>
                    </center>
                </div>
