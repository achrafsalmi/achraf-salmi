...
<html>
    ...
    <body>
        <nav class="main-nav-outer" id="test">
            ...
            <div class="container">
                <ul class="main-nav">
                    <li><a href="<%=request.getContextPath() + "/acc_home"%>">Home</a></li>
            ...
            <div class="container">
                ...
                <form method="post" action="rech_tel">
                    <center>
                        ...
                        <br>
                        <input type="submit" class="link animated fadeInUp delay-1s servicelink" name="bt_action"  value="Recherche_client"/>
