...
String SN = pers.rechsn(l);
                            ...
                            <td>
                                ...
                                <form style="margin:0px;" method="post" action="acct_histo">
                                    ...
                                    <button type="submit" name="bt_histo" value="historique" title="historique client"><img style="width: 20px;height: 20px" src="ph/icons8-liste-64.png"/></button>
                                </form>
                                    ...
                                    <button type="submit" name="modif" value="actualiser info" title="actualiser"><img style="width: 20px;height: 20px" src="ph/ac.png"/></button>
                                    </form>
