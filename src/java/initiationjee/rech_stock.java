...
public class rech_stock extends HttpServlet {
...
if (log!=null){
        ...
        req.setAttribute("name1", n);
        req.getRequestDispatcher("BD_stock.jsp").forward(req, resp);
}
else{
