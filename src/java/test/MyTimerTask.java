...
public class MyTimerTask extends TimerTask {
    ...
    public void run() {
        ...
        long stopTime = currennTime + 10000;//provide the 2hrs time it should execute 1000*60*60*2
    ...
    public static void startTask(){
        ...
        timer.schedule(task,getTomorrowMorning2AM(),90000*10);// for your case u need to give 1000*60*60*24
    }
