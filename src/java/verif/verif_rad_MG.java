    ...
    String sql = "select tel_adsl from 1_cnx_fact_RM";
        ...
        try {
            ...
            String tel1=Integer.toString(tel);
                ...
                verif_rad_MG.recherche_tel(tel);
...
verif_rad_MG.insert(mac,tel,Nom);
            }
        } catch (SQLException e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
     ...
     public static void insert (String histo,int tel,String Nom) {
        ...
        String sql = "update 1_cnx_fact_RM SET Nom='" + Nom + "',modif= '"+histo+"'where tel_adsl='"+tel+"'";
        ResultSet res1;
        int i = 0;
        try {
            PreparedStatement ps = connection.getConnection().prepareStatement(sql);
