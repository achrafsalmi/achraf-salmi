...
public class verif_fact {
    ...
    public static void recherche_tel(int tel) {
        ...
        try {
            ...
            while (res1.next()) {
                ...
                verif_fact.recherche_histo(mac, tel);
            }
        } catch (SQLException e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
    ...
    public static void insert(String histo, int tel) {
        ...
        String sql = "update 1_cnx_fact SET  etat_cnx= '" + histo + "'where tel_adsl='" + tel + "'";
        ResultSet res1;
        int i = 0;
        try {
            PreparedStatement ps = connection.getConnection().prepareStatement(sql);
    ...
    public static void vider() {
        String sql = "TRUNCATE 1_cnx_fact";
        ResultSet res;
        int i = 0;
        try {
            PreparedStatement ps = connection.getConnection().prepareStatement(sql);
