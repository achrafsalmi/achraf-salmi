            ...
            <div class="container">
                ...
                <center>
                    <%persImpli ps = new persImpli();
                        ...
                        String sql = "select * from total02-08-2021 WHERE `username` LIKE '%" + s + "%'ORDER BY `radacctid` DESC LIMIT 100";
                        ResultSet res = null;
                    ...
                    <center>
                        ...
                        <form method="post" action="acct_histo">
                            <input type="hidden" name="id" value="<%=p%>">
                            <input type="hidden" name="Nom" value="<%=n%>">
                            <input type="hidden" name="telephone" value="<%=t%>">
                            <input type="date" name="date_rech"/>
                            <input type="submit" name="bt_histo" value="historique_total">
                        </form>
                        <%}%>
                    </center>
                </center>
                ...
                <table id="example" class="display" style="width:100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><% String nas=res.getString("nasipaddress");
                            if(nas.startsWith("10")){
                            out.println("lns_wardia ip:"+nas);
                            }else{
