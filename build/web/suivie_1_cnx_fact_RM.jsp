...
<%@page import="verif.verif_fact_RM"%>
...
<LINK href="https://code.jquery.com/ui/1.12.1/themes/base/jquery-ui.css" rel=stylesheet type=text/css>
  <LINK href="https://cdn.datatables.net/1.10.20/css/dataTables.jqueryui.min.css" rel=stylesheet type=text/css>
    ...
    <body style="color: black;">
        <nav class="main-nav-outer" id="test">
            ...
            <div class="container">
                 <ul class="main-nav">
                    <li><a href="<%=request.getContextPath() + "/acceuil_fact_RM"%>">Home</a></li>
                    <li><a href="<%=request.getContextPath() + "/upload_fact_RM"%>">import</a></li>
                    <li class="small-logo"><a href="#header"><img src="img/small-logo.png" alt=""></a></li>
                    <li><a href="<%=request.getContextPath() + "/suivie_fact_RM"%>">1 connexion</a></li>
 ...
 String sql = "select * from 1_cnx_fact_RM";
        ResultSet res=null;
...
PreparedStatement ps1 = conn.getConnection().prepareStatement(sql);
 ...
 %>
            <tr>
                ...
                <td><%=res.getString("etat_cnx")%></td>
                <td><%=res.getString("stoptime")%></td>
                <td><%
                String mac =res.getString("modif");
                String msg="Non ajouté";
                if(mac==null){
                                    %>
                    ...
                    <%int k=res.getInt("tel_adsl");%>
                    <td><%=verif_fact_RM.recherche_reclamation(k)%></td>
                    <td><%=res.getString("mes_date")%></td>
            </tr>
            <%}%>
