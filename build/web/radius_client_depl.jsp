        ...
        <section class="main-section paddind" id="Portfolio">
            ...
            <table id="example" class="display" >
                ...
                <form style="margin:0px;" method="post" action="acct_histo">
                    ...
                    <button type="submit" name="bt_histo" value="histo_depl" title="historique  client"><img style="width: 20px;height: 20px" src="ph/icons8-liste-64.png"/></button>
                </form>
                ...
                <form   method="post" class="d-flex" action="BEE1" >
                  ...
                  <%  String s2="SELECT * FROM `wf` WHERE `tel_adsl` LIKE '%"+s7+"%'" ;
            PreparedStatement ps2 = conn1.getConnection().prepareStatement(s2);
                res1 = ps2.executeQuery(s2);%>
                <td>
                ...
                <tbody>
                    ...
                    %>
                    <tr>
                        <td><%=res1.getString("ref_tt")%></td>
                        <td><%=res1.getString("tel_adsl")%></td>
                        <td><%=res1.getString("region")%></td>
                        <td><%=res1.getString("contact")%></td>
                        <td><%=res1.getString("date_depot")%></td>
                        <td><%=res1.getString("type_demande")%></td>
                        <td><%=res1.getString("client")%></td>
                        <td><%=res1.getString("debit")%></td>
                        <td><%=res1.getString("cin")%></td>
                        <td><%=res1.getString("etat")%></td>
                        <td><%=res1.getString("date_etat")%></td>
                        <td><%=res1.getString("csc")%></td>
                        <td><%=res1.getString("motif_instance")%></td>
                        </tr>
                    <%}%>
